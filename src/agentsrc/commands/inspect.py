...
def main(
    package_name: str = typer.Argument(..., help="Name of the package to inspect")
):
    """
    ...
    if not pkg_dir.exists():
        console.print(f"[bold red]Error:[/bold red] Package [cyan]{package_name}[/cyan] is not synced.")
    ...
    if not versions:
        console.print(f"[bold red]Error:[/bold red] No versions found for [cyan]{package_name}[/cyan].")
        raise typer.Exit(code=1)
